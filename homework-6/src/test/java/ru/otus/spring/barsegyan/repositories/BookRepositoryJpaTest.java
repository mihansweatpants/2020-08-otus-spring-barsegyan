...
class BookRepositoryJpaTest {
    ...
    void findAll() {
        ...
        assertThat(books).isNotNull().hasSize(EXPECTED_NUMBER_OF_BOOKS)
                ...
                .allMatch(book -> book.getReviews() != null && book.getReviews().size() > 0);
    }

    @Test
    @DisplayName("find book by id")
    void findById() {
        var optionalExpectedBook = bookRepositoryJpa.findById(FIRST_BOOK_ID);
    ...
    void save() {
        ...
        assertThat(bookRepositoryJpa.findAll()).size().isGreaterThan(EXPECTED_NUMBER_OF_BOOKS);
    }
    ...
    void update() {
        ...
        assertThat(bookRepositoryJpa.save(bookToUpdate))
