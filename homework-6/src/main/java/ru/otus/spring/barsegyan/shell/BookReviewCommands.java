...
import ru.otus.spring.barsegyan.services.BookReviewService;
...
public class BookReviewCommands {
    ...
    public String getReviewsByBookId(@ShellOption long bookId) {
    ...
    public String addReview(@ShellOption long bookId,
    ...
    public void deleteReview(@ShellOption long reviewId) {
