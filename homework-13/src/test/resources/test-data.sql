...
insert into app_user (app_user_id, username, password, role)
values (1, 'admin', '$2a$10$jvNMCO4mLpXlxBfGS9VwWeTuyuV66DlW9o4zKs7FYZB8mfbAqDUCS', 'ROLE_ADMIN'), -- bcrypt(admin)
       (2, 'test_user', '$2y$10$LRRj7mBLG3ZC8tW.XTMSE.1sdTF66WpG1YuMu6VaZymwg85DVTP06', 'ROLE_USER'); -- bcrypt(test_user)
